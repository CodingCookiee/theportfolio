    ...
    <section className="c-space my-20" id="about">
      ...
      <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container bg-light-secondary dark:bg-dark-secondary">
            <img
              ...
              alt="grid-1"
              className="shadow-lg rounded-md w-full sm:h-[276px] h-fit object-contain"
            />
            <div>
        ...
        <div className="col-span-1 xl:row-span-3">
          <div className="grid-container bg-light-secondary dark:bg-dark-secondary">
            <img
              src={isDark ? "assets/stack-dark.png" : "assets/stack-light.png"}
              alt="grid-2"
              className="w-full sm:h-[276px] h-fit object-contain shadow-lg"
            />
            <div>
              <p className="grid-headtext text-light-text dark:text-dark-text">
                Tech Stack
        ...
        <div className="col-span-1 xl:row-span-4">
          <div className="grid-container bg-light-secondary dark:bg-dark-secondary">
            ...
            <div>
              ...
              <p className="grid-subtext text-light-text dark:text-dark-text">
                I&apos;m based in Rawalpindi, Pakistan and open to remote work
                worldwide.
              </p>
              <Button
                name="Contact Me"
        ...
        <div className="xl:col-span-2 xl:row-span-3">
          <div className="grid-container bg-light-secondary dark:bg-dark-secondary">
            <img
              src={isDark ? "assets/grid3.png" : "assets/grid-code.png"}
              alt="grid-3"
              className=" rounded-md shadow-lg w-full sm:h-[266px] h-fit object-contain"
            />
            <div>
              <p className="grid-headtext text-light-text dark:text-dark-text">
              ...
              <p className="grid-subtext text-light-text dark:text-dark-text">
                I priortize creativity and minimalism . I enjoy exploring
                designing and developing websites with exquisite and minmalistic
                design..
              </p>
            </div>
          </div>
        ...
        <div className="xl:col-span-1 xl:row-span-2">
          <div className="grid-container bg-light-secondary dark:bg-dark-secondary">
            ...
            <div className="space-y-2">
              <p className="grid-subtext text-center text-light-text dark:text-dark-text">
                Contact me
              </p>
